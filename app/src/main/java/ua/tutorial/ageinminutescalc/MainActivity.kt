package ua.tutorial.ageinminutescalc
   ...
   private fun clickDatePicker(){
        ...
        val dpd =  DatePickerDialog(this,
            ...
            { _, selectedYear, selectedMonth, selectedDayOfMonth ->
                ...
                val diffetenceInMinutes = currentDateInMinutes - selectedDateInMinutes

                tvAgeInMinutes?.text = diffetenceInMinutes.toString()
            },
            year,
            month,
            day
